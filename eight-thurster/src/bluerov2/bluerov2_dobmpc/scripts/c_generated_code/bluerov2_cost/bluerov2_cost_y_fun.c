...
/* bluerov2_cost_y_fun:(i0[12],i1[4],i2[0],i3[],i4[6])->(o0[16]) */
...
CASADI_SYMBOL_EXPORT casadi_int bluerov2_cost_y_fun_n_in(void) { return 5;}
...
CASADI_SYMBOL_EXPORT int bluerov2_cost_y_fun_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
